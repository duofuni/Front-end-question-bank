module.exports = {
  list: [
    ...
    },
    {
      ...
      answer: 0,
      reason:
        "模块化、组件化、规范化和自动化，详情https://blog.csdn.net/weixin_42402867/article/details/113573501",
    },
    {
      id: 20,
      title: "比较熟悉的设计模式，并且举出例子",
      items: [
        "观察者模式（点击进入下一题）",
        "代理模式",
        "工厂模式",
      ...
      answer: 0,
      reason:
        "1.观察者模式：事件，发布订阅；2.代理模式：proxy；3.工厂模式：axios.create；4.单例模式：Vue、getSingleInstance；5.",
    },
    {
      id: 21,
      title: "说说节流和防抖？",
      items: [
        "节流是防止行为过多，防抖是只执行最后一次行为",
        "节流是只执行最后一次行为，防抖是防止行为过多",
        "节流是 throttle，防抖是 debounce",
        "节流和防抖没有区别",
      ],
      answer: 0,
      reason: "",
